...
class __TwigTemplate_3a112a67922ff3bb75f1f08707b7d2b0c46d3760b7c92c1048e613c8d344cad5 extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    <link rel=\"icon\" type=\"image/x-icon\" href=\"./assets/logo/logo plik otwarty jedno złote.png\">
    <meta charset=\"utf-8\">
    <script>
    ...
    <nav class=\"row m-0\">
        <div class=\"row fw-bold m-0\">
            <div class=\"col-md-12 col-xl-3\">
                <img src=\"./assets/logo/logo bez tła.png\" alt=\"Logo\" class=\"d-block p-0 mx-auto\" style=\"height: 170px;\">
            </div>
            <div class=\"col-sm-12 col-md-4 col-xl-3 pt-3\">
                <div class=\"pt-4 headerButton mx-auto\">
                    <a href=\"./StronaGLowna.html\" class=\"d-block text-center p-4\">
                        Strona główna
                    </a>
                </div>
            </div>
            <div class=\"col-sm-12 col-md-4 col-xl-3 pt-3\">
                <div class=\"pt-4 headerButton\">
                    <a href=\"./Realizacje.html\" class=\"d-block text-center p-4 mx-auto\">
                        Realizacje
                    </a>
                </div>
            </div>
            <div class=\"col-sm-12 col-md-4 col-xl-3 pt-3 pb-3\">
                <div class=\"pt-4 headerButton mx-auto\">
                    <a href=\"NapiszDoNas.html\" class=\"d-block text-center p-4\">
                        Kontakt
                    </a>
                </div>
            </div>
    ...
    <main>
        <div class=\"row w-100 d-flexbox text-center m-0 py-5 imageRow\">
            ...
            <div class=\"col-md-6 col-sm-12 text-center p-2 m-0\">
                <img src=\"./data/images/zadaszenie2.jpg\" alt=\"Zdjęcie Prezentacyjne\" class=\"rounded mx-auto w-100\">
            </div>
        ...
        <div class=\"row w-100 d-flexbox text-center m-0 py-5 imageRow\">
            ...
            <div class=\"col-md-6 col-sm-12 text-center p-2 m-0\">
                <img src=\"./data/images/garaz.jpg\" alt=\"Zdjęcie Prezentacyjne\" class=\"rounded mx-auto w-100\">
            </div>
        </div>
        ...
        <div class=\"row w-100 d-flexbox text-center m-0 py-5 imageRow\">
            ...
            <div class=\"col-md-6 col-sm-12 text-center p-2 m-0\">
                <img src=\"./data/images/aac34e108aae826f1a4572314bc1d896.jpg\" alt=\"Zdjęcie Prezentacyjne\" style=\"max-width: 400px;\" class=\"rounded mx-auto w-100\">
            </div>
            <div class=\"col-md-6 col-sm-12 m-auto font-weight-bold p-5\">
    ...
    <footer class=\"w-100 row d-block m-0 p-0\">
            <div class=\"d0 text-center col m-0\">
                ...
                <div class=\"row pt-2 m-0\">
                    ...
                    <li class=\"pt-3 col-md-3 col-sm-6\">
                        <a href=\"NapiszDoNas.html\">Kontakt</a>
                    </li>
                    <li class=\"pt-3 col-md-3 col-sm-6\">
...
</html>", "Realizacje.html.twig", "C:\\Users\\Wojtek\\Desktop\\Coding\\ArtekWebpage\\templates\\Realizacje.html.twig");
    }
}
