...
class __TwigTemplate_fc17fc77a6e834860880eac66402162c047b6ecd8c3c40f511817012a0e9eb6b extends Template
{
    private $source;
    private $macros = [];
...
<body>
    ...
    <!--Zdjęcie główne-->
        <div class=\"text-center zdjecieGlowneTekst w-100\">
    ...
    <main class=\"\">
        ...
        <div class=\"row w-100 d-flexbox text-center m-0 py-5 imageRow\">
            ...
            <div class=\"col-md-6 col-sm-12 text-center p-2 m-0\">
                <img src=\"./data/images/lozko-drewniane-debowe-nowoczesne-9021.jpg\" alt=\"Zdjęcie Prezentacyjne\" style=\"max-width: 400px;\" class=\"rounded mx-auto w-100\">
            </div>
            <div class=\"col-md-6 col-sm-12 m-auto font-weight-bold p-5\">
